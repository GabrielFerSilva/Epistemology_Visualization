const conexoes_ideia_autor = [{
    ...
    to: "I000000004", 
    label: "Concorda", 
    sentence: "Onde ele fala em incomensurabilidade tout court, tenho falado regularmente também em comunicação parcial, que acredito suscetível de melhora até onde as circunstâncias o requeiram e a paciência o permita, assunto que será desenvolvido mais adiante.",
    ...
    to: "I000000002", 
    label: "Discorda", 
    sentence: "Admito que a qualquer momento somos prisioneiros apanhados no referencial das nossas teorias; das nossas expectativas; das nossas experiências passadas; da nossa linguagem. Mas somos prisioneiros num sentido pickwickiano; se o tentarmos, poderemos sair de nosso referencial a qualquer momento. Ê verdade que tornaremos a encontrar-nos em outro referencial, mas este será melhor e mais espaçoso; e poderemos, a quaisquer momento, deixá-lo também.",
    ...
    to: "I000000003", 
    label: "Concorda", 
    sentence: "Refiro-me à sua afirmativa de que os paradigmas sucessivos só podem ser avaliados com dificuldade e que eles podem ser de todo incomparáveis, pelo menos na medida em que estão em jogo os padrões mais familiares de comparação (...).",
    book: "FEREYABEND, Paul. Consolando o Especialista. In: LAKATOS, Imre; MUSGRAVE, Alan (Org.). A Crítica e o Desenvolvimento do Conhecimento. Tradução de Octavio Mendes Cajado. São Paulo: Cultrix; Ed. da Universidade de São Paulo, 1979.",
    page: "271",
    writer: "Paul Fereyabend",
},{
    id: "CIA00000005", 
    from: "E000003", 
    to: "I000000005", 
